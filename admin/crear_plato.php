...
if (isset($_POST['create'])){
  ...
  $target = "/home/z71akgibyp47/public_html/admin/img_menu/".basename($_FILES['imagen']['name']);
  ...
  if ($result) {
    ...
    echo "<script>alert('Producto Duplicado')</script>";
  };
...
if (isset($_GET['edit'])) {
  ...
  if (count($result) == 1) {
    ...
    if (isset($_POST['update']) and $_SERVER['REQUEST_METHOD'] == "POST") {
      ...
      $new_target = "/home/z71akgibyp47/public_html/admin/img_menu/".basename($_FILES['imagen']['name']);
    ...
    <section class="container">
        <form method="POST" id="form" enctype="multipart/form-data">
          ...
          ?>
            ...
            <a href="menudb.php" class="btn btn-dark">Regresar</a>
            <!--Cambio Variable GET-->
            <?php if ($update == true) { ?>
